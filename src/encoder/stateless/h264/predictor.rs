...
pub(crate) type LowDelayH264<Picture, Reference> =
    LowDelay<Picture, DpbEntry<Reference>, LowDelayH264Delegate, BackendRequest<Picture, Reference>>;
...
impl<Picture, Reference> LowDelayDelegate<Picture, DpbEntry<Reference>, BackendRequest<Picture, Reference>>

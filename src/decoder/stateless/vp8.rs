...
pub struct Vp8DecoderState<B: StatelessDecoderBackend> {
...
impl<B: StatelessDecoderBackend> Default for Vp8DecoderState<B> {
    fn default() -> Self {
        Self {
...
impl<B> StatelessVideoDecoder<B> for StatelessDecoder<Vp8, B>
where
